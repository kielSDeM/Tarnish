...
then
    qemu-system-x86_64 -drive file=~/tarnish/src/linux/virt/lubu.qcow2,format=raw -boot d \
    -cdrom ~/tarnish/src/linux/virt/qemu_iso/lubuntu-20.04.4-desktop-amd64.iso  -m 2048M -cpu host \
    -smp 1\
    -vga qxl -enable-kvm 
